...
export default async function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-white font-mono text-black selection:bg-[#A3E635]">
      {/* --- RELEVANT HEADER --- */}
      <div className="flex items-end justify-between border-b-8 border-black p-10">
        <div>
          <h1 className="text-7xl leading-none font-black tracking-tighter uppercase italic">
            Habo.Insights
          </h1>
          <p className="mt-2 text-xs font-bold tracking-[0.3em] text-black/40 uppercase">
            Real-time Habit Platform Analytics
          </p>
        </div>
        <div className="hidden border-l-4 border-black pl-6 md:block">
          <p className="text-[10px] font-black text-black/40 uppercase">
            Gross Revenue
          </p>
          <p className="text-4xl font-black text-[#A3E635] italic">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="grid flex-1 grid-cols-1 md:grid-cols-2">
          <MetricBox
            ...
            className="border-r-4 border-b-4 border-black"
          />
        ...
        {/* --- APP HEALTH SIDEBAR --- */}
        <div className="w-full border-l-0 border-black p-10 lg:w-1/4 lg:border-l-8">
...
function MetricBox({ label, value, subtext, icon, className }: any) {
  return (
    <div className={cn("group p-12 transition-all hover:bg-black", className)}>
      ...
      <p className="text-9xl leading-none font-black tracking-tighter italic group-hover:text-white">
        {value}
      </p>
